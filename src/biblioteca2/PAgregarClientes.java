 ...
 * @author Thinkpad
 */
public class PAgregarClientes extends javax.swing.JFrame {

    /**
     * Creates new form PAgregarClientes
     */
    public PAgregarClientes() {
        initComponents();
        MostrarClientes();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PAgregarClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PAgregarClientes().setVisible(true);
            }
        });
    }
    
    public void MostrarClientes(){
        Biblioteca2 mostrarclientes = new Biblioteca2();
        DefaultTableModel mostrar = mostrarclientes.MostrarClientes();
        TablaClientes.setModel(mostrar);        
    }
